...
#define CROSSPAD_PC_REQUIRES_CORE_MAJOR 0
#define CROSSPAD_PC_REQUIRES_CORE_MINOR 6
#define CROSSPAD_PC_REQUIRES_CORE_PATCH 0

#define CROSSPAD_PC_REQUIRES_GUI_MAJOR 0
#define CROSSPAD_PC_REQUIRES_GUI_MINOR 3
#define CROSSPAD_PC_REQUIRES_GUI_PATCH 1
